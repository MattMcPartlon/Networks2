...
set f0 [open out0Newreno_Vegas_10_1BR.tr w]
set f1 [open out1Newreno_Vegas_10_1BR.tr w]
set f2 [open out2Newreno_Vegas_10_1BR.tr w]
...
set nf [open outNewreno_Vegas_10_1BR.nam w]
set nf2 [open out_mainNewreno_Vegas_10_1BR.tr w]
$ns namtrace-all $nf
$ns trace-all $nf2
